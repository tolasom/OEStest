/*! timer.jquery 0.6.1 2016-06-16*/ ! function(a) {
    function b(d) {
    ...
    var f = function() {
        ...
        k = function() {
            function a(b, c) {
                if (e(this, a), this.element = b, this.originalConfig = $.extend({}, c), this.totalSeconds = 0, this.intervalId = null, this.html = "html", "INPUT" !== b.tagName && "TEXTAREA" !== b.tagName || (this.html = "val"), this.config = j["default"].getDefaultConfig(), c && "string" != typeof c && (c.duration && (c.duration = j["default"].durationTimeToSeconds(c.duration)), this.config = $.extend(this.config, c), this.config.seconds && (this.totalSeconds = this.config.seconds), this.config.editable && j["default"].makeEditable(this), this.startTime = j["default"].unixSeconds() - this.totalSeconds, this.config.duration && this.config.repeat && this.config.updateFrequency < 1e3 && (this.config.updateFrequency = 1e3), this.config.countdown)) {
